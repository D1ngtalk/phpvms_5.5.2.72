	...
	<div class="col-lg-12 col-md-12 col-12 col-sm-12">
        <div class="card">
            ...
            <div class="card-header">
                <h4><?php echo $folder->folder_title; ?></h4>
                <div class="card-header-action">
                    <a href="<?php echo SITE_URL.'/index.php/Mail/editfolder/'.$folder->id; ?>" class="btn btn-info">编辑文件夹</a>
                </div>
            </div>
            <?php } ?>
            <div class="card-body">
                <div class="card-contact">
                    <?php
                        if(!$mail) {
                            echo '<div class="alert alert-primary">当前没有信息</div>';
                        } else {
                    ?>
                        ...
                        <table class="table table-striped table-hover" id="table-1">
                            ...
                            <tbody> 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo date('Y-m-d H:i:s', strtotime($data->date)); ?>
                                    </td>
                                    <td>
                                        <a class="btn btn-danger" href="<?php echo SITE_URL ?>/index.php/Mail/delete/<?php echo $data->id;?>">删除</a>
                                    </td>
                                </tr>
                                <?php } ?>
                            </tbody>
                    ...
                    <center><a class="mt-3 btn btn-danger" href="<?php echo url('/mail/delete_all/').$data->reciever_folder; ?>" onclick="return confirm('确定要删除所有信息吗')">全部删除</a></center>
                </div>
            </div>
        </div>
    </div>
