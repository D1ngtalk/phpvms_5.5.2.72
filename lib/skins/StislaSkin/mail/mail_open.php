            ...
            <div class="card-body">
                ...
                <div class="ticket-form" style="margin-top: 10px;">
                    <div class="form-group">
                        <a href="<?php echo SITE_URL ?>/index.php/Mail/move_message/<?php echo $data->id;?>" class="btn btn-primary btn-lg">存档</a>
                        <a href="<?php echo SITE_URL ?>/index.php/Mail/reply/<?php echo $data->thread_id;?>" class="btn btn-primary btn-lg float-right">回复</a>
                    </div>
                </div>
            </div>
        </div>
