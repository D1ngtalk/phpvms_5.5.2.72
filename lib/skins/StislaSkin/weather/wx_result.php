...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><?php echo $icao; ?>的天气</div>
    </div>
</div>
					...
					<div class="row">
						<div class="col-sm-9">
							<ul class="nav nav-pills" id="wxTab" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" id="airport-tab" data-toggle="tab" href="#airportTab" role="tab" aria-controls="airport" aria-selected="true">机场信息</a>
								</li>
								<li class="nav-item">
						...
						<div class="col-sm-3" style="align-self: center;">
							<form method="post" action="<?php echo url('/weather'); ?>">
								<div class="input-group">
									<input type="text" name="icao" class="form-control" placeholder="机场的ICAO代码" style="border-radius: 30px 0 0 30px !important; height: 36px;">
						...
						<div class="card">
							<div class="card-body">
								<div class="card-contact">
									...
									<div class="contact-item">
										<h6>标高</h6>
										<span class="float-right align-right"><?php echo $station['data'][0]['elevation']['feet']; ?> ft</span>
									</div>
									<div class="contact-item">
										<h6>类型</h6>
						...
						<div class="card">
							<div class="card-body">
								<div class="card-contact">
									...
									<div class="contact-item">
										<h6>时差</h6>
										<span class="float-right align-right">UTC +<?php echo $station['data'][0]['timezone']['dst']; ?></span>
									</div>
									<div class="contact-item">
										<h6>当前时间</h6>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="card-contact">
									...
									<div class="contact-item">
										<h6>风</h6>
										<span class="float-right align-right"><?php echo $metar['data'][0]['wind']['degrees'].'º '.$metar['data'][0]['wind']['speed_mps'].' 米每秒'; ?></span>
									</div>
									<div class="contact-item">
										<h6>能见度</h6>
										<span class="float-right align-right">
									...
									<div class="contact-item">
										<h6>气压</h6>
										<span class="float-right align-right">
											<?php echo $metar['data'][0]['barometer']['mb'].' 百帕 / '.$metar['data'][0]['barometer']['hg'].' 英寸汞柱'; ?>
										</span>
									</div>
								...
								<div class="card-contact">
									<div class="row">
										...
										<div class="col-12 col-md-4">
											<div class="contact-item">
												<h6>风</h6>
												<span class="float-right align-right"><?php echo $taf['data'][0]['forecast'][0]['wind']['degrees'].'º '.$taf['data'][0]['forecast'][0]['wind']['speed_mps'].' 米每秒'; ?></span>
											</div>
											<div class="contact-item">
												<h6>云况</h6>
												<span class="float-right align-right">
										...
										<div class="col-12 col-md-4">
											...
											<p>
												<?php echo $dtFrom->format("Y/m/d H:i");  ?> UTC
												<br/>
												<?php echo date("j \\天\, G \\小时\, i \\分钟\ \\前", $diffFrom); ?>
											</p>
										</div>
										...
										<div class="col-12 col-md-4">
											...
											<p>
												<?php echo $dtfTo->format("Y/m/d H:i");  ?> UTC
												<br/>
												<?php echo date("j \\天\, G \\小时\, i \\分钟\ \\后", $diffTo); ?>
											</p>
										</div>
									</div>
								</div>
