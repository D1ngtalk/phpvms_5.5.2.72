    ...
    <div class="row">
        <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo url('/login');?>" name="loginform" class="needs-validation" novalidate="">
                        <div class="form-group">
                            <label for="email">邮箱或飞行员ID</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="submit" class="btn btn-primary btn-lg btn-block" name="submit" value="登录" tabindex="4" />
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="mt-5 text-muted text-center">
                还没有账号？ <a href="<?php echo SITE_URL?>/index.php/registration">创建一个</a>
            </div>
