...
?>
<table border = "0" width="100%" class="table acarsmap">
    <thead>
        <tr>
            <th><b>飞行员</b></th>
            <th><b>航班号</b></th>
...
<tr class="<%=flight.trclass%>">
    <th scope="col"><a href="<?php echo url('/profile/view');?>/<%=flight.pilotid%>"><%=flight.pilotid%> - <%=flight.pilotname%></a></th>
...
<strong>航班 <%=flight.flightnum%></strong> (<%=flight.depicao%> to <%=flight.arricao%>)<br />
<strong>状态: </strong><%=flight.phasedetail%><br />
<strong>剩余距离/剩余时间: </strong><%=flight.distremaining%> <?php echo Config::Get('UNITS');?> / <%=flight.timeremaining%><br />
</span>
</script>
